...
python main_mp.py --model_config model_cfg.json --pipeline_config ./policy/preload_all.json --gpu_ids 0 1 2 3  --save_json
# step 8. training with Data residing in host main memory + SGDRR + GPU-side Double buffering
python main_mp.py --model_config model_cfg.json --pipeline_config ./policy/uvm_RR.json --gpu_ids 0 1 2 3 --save_json
# step 9. training with Data residing in host main memory + SGDCR + GPU-side Double buffering
python main_mp.py --model_config model_cfg.json --pipeline_config ./policy/uvm_CR.json --gpu_ids 0 1 2 3 --save_json
...
python auto_run.py --model_config model_acc_cfg.json