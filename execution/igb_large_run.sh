...
base_command_HOGA="CUDA_VISIBLE_DEVICES=0 python main.py --method HOGA --dataset igb --dataset_size large --device 0 --runs 5 --test_start_epoch -1 --eval_step 10 --metric acc --patience 1000 --weight_decay 0.0 --epochs 10 --data_dir /scratch/graph_data/ --lr 0.001 --weight_decay 0 --num_heads 4 --hidden_channels 256 --mlplayers 2 --dropout 0.1 --attn_dropout 0.0 --input_dropout 0.0 --eval_batch --use_post_res 1 --input_type da --num_layers 1 --save_result --batch_size 8000 --load_all --mode gpu --save_result --chunk_size 1"

base_command_SIGN="CUDA_VISIBLE_DEVICES=0 python main.py --method SIGN --dataset igb --dataset_size large --device 0 --runs 5 --test_start_epoch -1 --eval_step 10 --metric acc --patience 1000 --weight_decay 0.0 --epochs 10 --data_dir /scratch/graph_data/ --lr 0.001 --weight_decay 0  --hidden_channels 512  --dropout 0.15 --eval_batch --use_post_res 1 --input_type da --num_layers 3 --save_result --batch_size 8000 --cat_input --load_all --mode gpu --save_result --chunk_size 1"
